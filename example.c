...
int main() {
    ...
    fplot(a, "data.dat", 1, 2); // Plotting the stored in file with column 1 as x axis and column 2 as y axis
    ...
    fplot(a, "data.dat", 3, 2); // Plotting the stored in file with column 3 as x axis and column 2 as y axis
    strcpy(a->t, "y=x^2"); // Changing the Legend title of the plot
    double arrx[] = {1, 2, 3, 4};
